...
#End Region
    ...
    Private Sub ButtonTrekkLodd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonTrekkLodd.Click
        ...
        'vis alle loddene i hatten fortløpende (lykkehjul) og end opp med vinnerloddet:
            For wi = 1 To (MengdeTilNr + wTrukketTall)
                ...
                'Liten forsinkelse mellom de første loddene, gradvis større forsinkelse når
                'man nærmer seg vinnerloddet:
